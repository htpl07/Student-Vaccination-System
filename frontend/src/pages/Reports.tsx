...
// import { Button, Card, Container, Group, Input, SimpleGrid, Text, Title, Stack } from '@mantine/core';
...
//   const downloadCSV = () => {
//     window.open(`http://127.0.0.1:8000/reports/download/csv?vaccine_name=${vaccine}`, "_blank");
//   };
